...
const (
	...
	AccountServiceName = "outbox.v1.AccountService"
)
...
const (
	...
	// CreateAccount RPC.
	AccountServiceCreateAccountProcedure = "/outbox.v1.AccountService/CreateAccount"
	// AccountServiceGetAccountProcedure is the fully-qualified name of the AccountService's GetAccount
	// RPC.
	AccountServiceGetAccountProcedure = "/outbox.v1.AccountService/GetAccount"
	// AccountServiceListAccountsProcedure is the fully-qualified name of the AccountService's
	// ListAccounts RPC.
	AccountServiceListAccountsProcedure = "/outbox.v1.AccountService/ListAccounts"
	// AccountServiceUpdateAccountProcedure is the fully-qualified name of the AccountService's
	// UpdateAccount RPC.
	AccountServiceUpdateAccountProcedure = "/outbox.v1.AccountService/UpdateAccount"
	// AccountServiceClaimAccountProcedure is the fully-qualified name of the AccountService's
	// ClaimAccount RPC.
	AccountServiceClaimAccountProcedure = "/outbox.v1.AccountService/ClaimAccount"
	// AccountServiceDeleteAccountProcedure is the fully-qualified name of the AccountService's
	// DeleteAccount RPC.
	AccountServiceDeleteAccountProcedure = "/outbox.v1.AccountService/DeleteAccount"
	// AccountServiceResolveAccountProcedure is the fully-qualified name of the AccountService's
	// ResolveAccount RPC.
	AccountServiceResolveAccountProcedure = "/outbox.v1.AccountService/ResolveAccount"
)
...
func NewAccountServiceHandler(svc AccountServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	accountServiceClaimAccountHandler := connect.NewUnaryHandler(
		AccountServiceClaimAccountProcedure,
		svc.ClaimAccount,
		connect.WithSchema(accountServiceMethods.ByName("ClaimAccount")),
		connect.WithHandlerOptions(opts...),
	)
	...
	accountServiceResolveAccountHandler := connect.NewUnaryHandler(
		AccountServiceResolveAccountProcedure,
		svc.ResolveAccount,
		connect.WithSchema(accountServiceMethods.ByName("ResolveAccount")),
		connect.WithHandlerOptions(opts...),
	)
	return "/outbox.v1.AccountService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		...
		case AccountServiceClaimAccountProcedure:
			accountServiceClaimAccountHandler.ServeHTTP(w, r)
		case AccountServiceDeleteAccountProcedure:
			accountServiceDeleteAccountHandler.ServeHTTP(w, r)
		case AccountServiceResolveAccountProcedure:
			accountServiceResolveAccountHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
